/*
  # Mall Administration Schema

  1. Tables
    - malls
    - shops
    - mall_shops (junction table for mall-shop relationship)
    - promotions
    - admin_users
    - user_profiles
  ...
  2. Policies
    ...
    - Mall Admin: Access to assigned mall and its shops/promotions
    - Shop Admin: Access to assigned shop's promotions in specific mall
*/
...
INSERT INTO auth.users (
  ...
  gen_random_uuid(),
  'ahsanmalik919@gmail.com',
  crypt('Zonahsan1@', gen_salt('bf')),
  now(),
  now(),
  now()
);
...
FROM auth.users
WHERE email = 'ahsanmalik919@gmail.com';
